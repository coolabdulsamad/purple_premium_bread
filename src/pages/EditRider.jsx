...
import '../assets/styles/editRider.css';
...
const EditRider = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        existing_guarantor1_id_image_url: '',
        ...
        existing_guarantor2_id_image_url: '',
    ...
    const fetchRiderDetails = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                id_image: null,
                profile_image: null,
                existing_id_image_url: riderData.id_image_url || '',
                existing_profile_image_url: riderData.profile_image_url || '',
                ...
                guarantor1_id_image: null,
                existing_guarantor1_id_image_url: riderData.guarantor1_id_image_url || '',
                ...
                guarantor2_id_image: null,
                existing_guarantor2_id_image_url: riderData.guarantor2_id_image_url || '',
                ...
                is_active: riderData.is_active !== false,
    ...
    const handleFileChange = (e, fieldName) => {
        ...
        const existingField = `existing_${fieldName}_url`;
        if (formData[existingField]) {
            setImagesToDelete(prev => [...prev, formData[existingField]]);
        }
    };
    ...
    const removeImage = (fieldName) => {
        ...
        setFormData(prev => ({ ...prev, [fieldName]: null, [existingField]: '' }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.product_prices && formData.product_prices.length > 0) {
                ...
                submitData.append('product_prices', JSON.stringify([]));
            }
            ...
            const response = await api.put(`/riders/${id}`, submitData);

            setSuccess('Rider updated successfully!');
            toast(<CustomToast id={`success-${Date.now()}`} type="success" message="Rider updated successfully" />);
            ...
            let errorMsg = 'Failed to update rider';
    ...
    if (loading) {
        return (
            <div className="edit-rider-loading">
        ...
        <div className="edit-rider-page">
            ...
            <div className="edit-header">
                ...
                <div className="header-title">
                    ...
                    <div>
                        <h1>Edit Rider: {formData.fullname}</h1>
                        <p className="header-subtitle">Update rider information and settings</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="rider-form">
                ...
                {/* Tab Content - Reuse same structure as RegisterRider but with edit-specific fields */}
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="form-group full-width">
                                        ...
                                        <p className="field-hint">Inactive riders cannot make new sales</p>
                                    </div>
                                </div>
                            </div>
