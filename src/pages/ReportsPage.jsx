...
import { FaFileInvoiceDollar, FaChartLine, FaShoppingBag, FaDollarSign, FaPrint, FaFilter, FaTrashAlt, FaCalendarAlt, FaStore, FaUsers, FaBox, FaCubes, FaExchangeAlt, FaSeedling, FaMoneyBillWave } from 'react-icons/fa';
import '../styles/forms.css';
import '../styles/reports.css'; // Dedicated styles for reports

const API_BASE_URL = 'http://localhost:5000/api';

const ReportsPage = () => {
    const [reportType, setReportType] = useState('profit-loss');
    const [reportResult, setReportResult] = useState(null); // Stores the entire { reportTitle, filtersUsed, reportData } object
    ...
    const generateReport = useCallback(async () => {
        ...
        try {
            ...
            const relevantFiltersMap = {
                ...
                'inventory-movement': ['startDate', 'endDate', 'productId', 'inventoryTransactionType'], // Removed branchId filter from frontend for this report
                    ...
                    return (
                        <Table striped bordered hover responsive className="report-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="3" className="text-end fw-bold">Grand Totals:</td>
                    ...
                    return (
                        <Table striped bordered hover responsive className="report-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="4" className="text-end fw-bold">Total Consumed:</td>
                    ...
                    return (
                        <Table striped bordered hover responsive className="report-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="text-end fw-bold">Grand Totals:</td>
                ...
                <Form onSubmit={(e) => { e.preventDefault(); generateReport(); }}>
                            ...
                            <Col md={3}>
                                <Form.Group>
                                    ...
                                    <Form.Control as="select" name="inventoryTransactionType" value={filterData.inventoryTransactionType} onChange={handleFilterChange}>
                                        ...
                                        {/* Removed b2b_out, waste, adjustment as they are not explicitly represented for finished products in your schema via a unified transactions table */}
                                    </Form.Control>
                                </Form.Group>
                            </Col>
                        )}
                    ...
                    <div className="d-flex justify-content-end mt-4">
                        <Button variant="outline-secondary" onClick={clearFilters} className="me-2">
                            <FaTrashAlt className="me-1" /> Clear Filters
                        </Button>
                        <Button variant="info" onClick={handlePrint} disabled={!reportResult || loading || (Array.isArray(reportResult.reportData) && reportResult.reportData.length === 0 && reportType !== 'profit-loss')}>
